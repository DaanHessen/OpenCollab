export default function TermsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold mb-8 font-[family-name:var(--font-playfair)]">Terms and Conditions</h1>
      <div className="prose dark:prose-invert max-w-none">
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to OpenCollab.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to OpenCollab, accessible from <a href="https://opencollab.dev" rel="external nofollow noopener" target="_blank">https://opencollab.dev</a></p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: daanh2002@gmail.com</p>
          </li>
          <li>
            <p>By visiting this page on our website: <a href="https://daanhessen.nl" rel="external nofollow noopener" target="_blank">https://daanhessen.nl</a></p>
          </li>
        </ul>
      </div>
    </div>
